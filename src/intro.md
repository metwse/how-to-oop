...
function. This allows you to decide *at runtime* which function to call. Its
syntax is a bit messy but you will get it after writing a few function
pointers.
...
practice OOP logic -
[with what you have already known](./01_traditional-approach.html).
